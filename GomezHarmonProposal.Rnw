...
The above plots show the proportion of wins vs each differential; they inform some intuition about the direction of the estimated coefficients. Teams that had more assists, steals and blocks than their opponent were more likely to win.  Not surprisingly, teams with negative turnover differentials were more likely to win than teams with positive turnover differentials (because they turned the ball over fewer times than their opponent) and teams that fouled less were more likely to win.  \\
