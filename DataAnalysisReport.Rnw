...
\hline
 & Estimate & 2.5 \% & 97.5 \% \\ 
  \hline
(Intercept) & 0.87 & 0.71 & 1.07 \\ 
  wfgp & 0.41 & 0.28 & 0.60 \\ 
  w3p & 0.88 & 0.72 & 1.08 \\ 
  wftp & 1.52 & 1.27 & 1.83 \\ 
  trdiff & 1.03 & 1.03 & 1.04 \\ 
  astdiff & 1.13 & 1.13 & 1.14 \\ 
  tdiff & 0.89 & 0.88 & 0.90 \\ 
  sdiff & 0.97 & 0.97 & 0.98 \\ 
  blkdiff & 1.15 & 1.14 & 1.16 \\ 
  pfdiff & 0.87 & 0.86 & 0.87 \\ 
  ot & 1.02 & 0.93 & 1.13 \\ 
  trdiff:ot & 1.00 & 0.98 & 1.01 \\ 
  sdiff:ot & 0.98 & 0.96 & 1.00 \\ 
  blkdiff:ot & 0.98 & 0.95 & 1.01 \\ 
  pfdiff:ot & 1.00 & 0.98 & 1.02 \\ 
  astdiff:ot & 0.99 & 0.97 & 1.01 \\ 
   \hline
\end{tabular}
...
For teams that increase their field goal percentage differential by one percent, the estimated odds ratio of the home team winning the game actually decreases by 59 percent, holding other variables constant. This effect is similar for three point percentage differential as well: The estimated odds of a home team winning decrease by 13 percent for games with one percent larger difference between the winning and losing team three point percentages. While these results may not seem intutitive, these percentages do not take into account the possibility that teams with higher percentages may simply have taken fewer shots and thus made a higher percentage of them, but not actually scored a great deal of points. Finally, interpretation that can be taken from the model is intuitive; the odds that the home team wins the game increase by between 26 and 83 percent for in games where the free-throw differential was one percent higher. \\
