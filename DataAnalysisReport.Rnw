...
(Intercept) & 0.87 & 0.41 & 0.52 \\ 
  ...
  wftp & 1.42 & 0.54 & 0.63 \\ 
  lftp & 0.60 & 0.34 & 0.41 \\ 
  trdiff & 1.03 & 0.51 & 0.51 \\ 
  astdiff & 1.15 & 0.53 & 0.54 \\ 
  tdiff & 0.90 & 0.47 & 0.47 \\ 
  sdiff & 0.98 & 0.49 & 0.50 \\ 
  blkdiff & 1.15 & 0.53 & 0.54 \\ 
  pfdiff & 0.87 & 0.46 & 0.47 \\ 
  ot & 0.99 & 0.47 & 0.52 \\ 
  trdiff:ot & 0.99 & 0.50 & 0.50 \\ 
  sdiff:ot & 0.97 & 0.49 & 0.50 \\ 
  blkdiff:ot & 0.98 & 0.49 & 0.50 \\ 
  pfdiff:ot & 1.00 & 0.50 & 0.51 \\ 
  astdiff:ot & 0.98 & 0.49 & 0.50 \\ 
   \hline
\end{tabular}
...
The results of the logistic regression shed some light on some fascinating results. Holding the effect of other covariates constant, we are 95 percent confident that the probability of 
