...
\begin{abstract}
College Basketball, including the NCAA Tournament, is growing in popularity and scope across the country. Winnng programs benefit from increased exposure, funding opportunities, and prestige. It is often of interest to try to predict which statistics are most strongly associated with winning a game. In order to analyze this, we fit binary logistic regression models to analyze data from 49844 college basketball games since the 2003 season in order to determine which variables were most strongly associated with the probability of the home team winning. 
...
\begin{tabular}{rrrrr}
 ...
 & Estimate & Std. Error & z value & Pr($>$$|$z$|$) \\ 
  \hline
(Intercept) & -0.14 & 0.12 & -1.18 & 0.24 \\ 
  wfgp & -1.50 & 0.20 & -7.31 & 0.00 \\ 
  lfgp & 1.46 & 0.21 & 6.96 & 0.00 \\ 
  w3p & -0.26 & 0.10 & -2.54 & 0.01 \\ 
  l3p & 0.44 & 0.11 & 3.95 & 0.00 \\ 
  wftp & 0.35 & 0.10 & 3.67 & 0.00 \\ 
  lftp & -0.51 & 0.08 & -6.21 & 0.00 \\ 
  trdiff & 0.03 & 0.00 & 20.84 & 0.00 \\ 
  astdiff & 0.14 & 0.00 & 49.23 & 0.00 \\ 
  tdiff & -0.11 & 0.00 & -30.57 & 0.00 \\ 
  sdiff & -0.02 & 0.00 & -6.44 & 0.00 \\ 
  blkdiff & 0.14 & 0.00 & 36.77 & 0.00 \\ 
  pfdiff & -0.14 & 0.00 & -54.42 & 0.00 \\ 
  ot & -0.01 & 0.05 & -0.15 & 0.88 \\ 
  trdiff:ot & -0.01 & 0.01 & -1.11 & 0.27 \\ 
  sdiff:ot & -0.03 & 0.01 & -2.23 & 0.03 \\ 
  blkdiff:ot & -0.02 & 0.01 & -1.46 & 0.14 \\ 
  pfdiff:ot & 0.00 & 0.01 & 0.22 & 0.82 \\ 
  astdiff:ot & -0.02 & 0.01 & -1.51 & 0.13 \\ 
   \hline
\end{tabular}
\caption{\label{tab:Regression} Table of regression coefficients and their standard errors with associated standardized statistics and p-values.}
\end{table}

\subsection{Effects on Winning}

% latex table generated in R 3.3.2 by xtable 1.8-2 package
% Thu Apr 13 14:02:08 2017
\begin{table}[ht]
\centering
\begin{tabular}{rrrrr}
  \hline
 & Estimate & Std. Error & z value & Pr($>$$|$z$|$) \\ 
  \hline
(Intercept) & 0.87 & 1.13 & 0.31 & 1.27 \\ 
  wfgp & 0.22 & 1.23 & 0.00 & 1.00 \\ 
  lfgp & 4.31 & 1.23 & 1052.58 & 1.00 \\ 
  w3p & 0.77 & 1.11 & 0.08 & 1.01 \\ 
  l3p & 1.56 & 1.12 & 51.88 & 1.00 \\ 
  wftp & 1.42 & 1.10 & 39.41 & 1.00 \\ 
  lftp & 0.60 & 1.09 & 0.00 & 1.00 \\ 
  trdiff & 1.03 & 1.00 & 1128324922.04 & 1.00 \\ 
  astdiff & 1.15 & 1.00 & 2395790040224777109644.00 & 1.00 \\ 
  tdiff & 0.90 & 1.00 & 0.00 & 1.00 \\ 
  sdiff & 0.98 & 1.00 & 0.00 & 1.00 \\ 
  blkdiff & 1.15 & 1.00 & 9301945809379318.00 & 1.00 \\ 
  pfdiff & 0.87 & 1.00 & 0.00 & 1.00 \\ 
  ot & 0.99 & 1.05 & 0.86 & 2.41 \\ 
  trdiff:ot & 0.99 & 1.01 & 0.33 & 1.31 \\ 
  sdiff:ot & 0.97 & 1.01 & 0.11 & 1.03 \\ 
  blkdiff:ot & 0.98 & 1.01 & 0.23 & 1.15 \\ 
  pfdiff:ot & 1.00 & 1.01 & 1.25 & 2.28 \\ 
  astdiff:ot & 0.98 & 1.01 & 0.22 & 1.14 \\ 
   \hline
\end{tabular}
\end{table}
